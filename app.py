...
def compute_builder_result(
    ...
    if opt_total_risky > 1e-12:
        display_weight_asset1_pct = float((opt_x1 / opt_total_risky) * 100.0)
        display_weight_asset2_pct = float((opt_x2 / opt_total_risky) * 100.0)
    else:
        fallback_mix = float(risky_mix_grid[optimal_idx])
        display_weight_asset1_pct = float(fallback_mix * 100.0)
        display_weight_asset2_pct = float((1.0 - fallback_mix) * 100.0)

    display_weight_total = display_weight_asset1_pct + display_weight_asset2_pct
    if display_weight_total > 1e-12:
        display_weight_asset1_pct = float((display_weight_asset1_pct / display_weight_total) * 100.0)
        display_weight_asset2_pct = float(100.0 - display_weight_asset1_pct)
    else:
        display_weight_asset1_pct = 50.0
        display_weight_asset2_pct = 50.0
    ...
    return {
        ...
        "display_weight_asset1_pct": display_weight_asset1_pct,
        "display_weight_asset2_pct": display_weight_asset2_pct,
        "opt_w1": opt_x1,
        "opt_w2": opt_x2,
